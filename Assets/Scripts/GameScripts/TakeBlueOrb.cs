...
public class TakeBlueOrb : MonoBehaviour
{
    [SerializeField]
    ...
    private void Start()
    {
        if (CharacterEvents.instance.blueOrb)
        {
    ...
    void Update()
    {
        if (playerInRange && !CharacterEvents.instance.blueOrb && Input.GetKeyDown(KeyCode.C))
        {
    ...
    private void AddOrbtoInventory(GameObject orb)
    {
        ...
        CharacterEvents.instance.blueOrb = true;
    }
}
