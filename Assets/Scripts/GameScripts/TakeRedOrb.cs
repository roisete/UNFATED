...
public class TakeRedOrb : MonoBehaviour
{
    [SerializeField]
    ...
    private void Start()
    {
        if (CharacterEvents.instance.redOrb)
        {
    ...
    void Update()
    {
        if (playerInRange && !CharacterEvents.instance.redOrb && Input.GetKeyDown(KeyCode.C))
        {
    ...
    private void addOrbtoInventory(GameObject orb)
    {
        ...
        CharacterEvents.instance.redOrb = true;
    }
}
