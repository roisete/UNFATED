...
public class TakeGreenOrb : MonoBehaviour
{
    [SerializeField]
    ...
    private void Start()
    {
        if (CharacterEvents.instance.greenOrb)
        {
    ...
    void Update()
    {
        if (playerInRange && !CharacterEvents.instance.greenOrb && Input.GetKeyDown(KeyCode.C))
        {
    ...
    private void addOrbtoInventory(GameObject orb)
    {
        ...
        CharacterEvents.instance.greenOrb = true;
    }
}
